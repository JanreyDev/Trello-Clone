                    ...
                    <div className='flex items-center justify-between'>
                        <div className='flex items-center space-x-2 sm:space-x-4 min-w-0'>
                            <Link href="/dashboard" className='flex items-center space-x-1 sm:space-x-2 text-gray-600 hover:text-gray-900 flex-shrink-0'>
                                ...
                                <span className='hidden sm:inline'>Back to dashbaoard</span>
                ...
                <div className='flex items-center space-x-2 sm:space-x-4'>
                    {isSignedIn ?
                        (<div className='flex flex-col sm:flex-row items-end sm:items-center space-y-1 sm:space-y-0 sm:space-x-4'>
                            <span className='text-xs sm:sm text-gray-600 hidden sm:block'>Welcome, {user.firstName ?? user.emailAddresses[0].emailAddress}</span>
                            <Link href="/dashboard">
