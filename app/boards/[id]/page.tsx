...
import { Calendar, Ghost, MoreHorizontal, Plus, User } from "lucide-react";
          ...
          <DialogHeader>
            ...
            <form className="space-y-4" onSubmit={handleUpdateBoard}>
              ...
              <div className="space-y-2">
                ...
                <div className="grid grid-cols-4 sm:grid-col-6 gap-2">
                  {
                    [
                      "bg-blue-500",
                      "bg-green-500",
        ...
        <DialogContent className="w-[95vw] max-w-[425px] mx-auto">
          ...
          <div className="space-y-4">
            ...
            <div className="flex justify-between pt-4">
              ...
              <Button type="button" onClick={() => setIsFIlterOpen(false)}>Apply Filter</Button>
            </div>
          </div>
        </DialogContent>
      </Dialog>
      ...
      <main className="container mx-auto px-2 sm:px-4 py-4 sm:py-6">
        ...
        >
          <div className="flex flex-col lg:flex-row lg:space-x-6 lg:overflow-x-auto lg:pb-6 lg:px-2 lg:-mx-2 lg:[&::-webkit-scrollbar]:h-2
                    ...
                    lg:[&::-webkit-scrollbar-thumb]:bg-gray-300 lg:[&::-webkit-scrollbar-thumb]
